...
$con = mysqli_connect("localhost","root","kampioentje99","admin_project");
...
if (!empty($_GET['q'])) {
	...
	if ($http_code == 200) {
		...
		foreach($tweet_data as $tweet) {
			...
			$sql = "INSERT INTO tbl_tweets (tweet,time,user,vote,avatar) VALUES('".$tweet['text']."','".$tweet['created_at']."','".$tweet['user']['screen_name']."', 0,'".$tweet['user']['profile_image_url']."')";
