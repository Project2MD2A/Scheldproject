...
if (!empty($_GET['q'])) {
	...
	$db_name="db_admin_project"; // Database name 
	$tbl_name="tb_tweets"; // Table name 
...
// Get values from form 
	$name=$_POST['text', 'created_at', 'screen_name', 'profile_image_url'];

// Insert data into mysql 
	$sql="INSERT INTO $tbl_name(tweet, time, user, avatar)VALUES('$name')";
